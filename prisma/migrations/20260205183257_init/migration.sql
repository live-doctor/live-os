...
CREATE TABLE "Store" (
    ...
    "manifestHash" TEXT,
    "format" TEXT NOT NULL DEFAULT 'casaos',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
...
CREATE TABLE "InstalledApp" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "InstalledApp_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "Store" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "InstalledApp_appId_storeId_idx" ON "InstalledApp"("appId", "storeId");
