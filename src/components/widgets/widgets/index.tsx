...
import { SystemPillsWidget } from "./system-pills";
import { FourStatsWidget } from "./four-stats";
import { TwoStatsGaugeWidget } from "./two-stats-gauge";
import { NetworkStatsWidget } from "./network-stats";
...
export function Widget({ type, data, selected, onClick }: WidgetProps) {
  const renderWidget = () => {
    switch (type) {
      ...
      case "system-pills":
        return <SystemPillsWidget data={data as SystemPillsData} />;
      case "four-stats":
      ...
      case "network-stats":
        return <NetworkStatsWidget data={data as NetworkWidgetData} />;
      case "custom":
        return <CustomWidget data={data as CustomWidgetData} />;
...
export { SystemPillsWidget } from "./system-pills";
...
export { CustomWidget } from "./custom";
