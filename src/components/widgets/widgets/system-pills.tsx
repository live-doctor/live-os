...
function CpuGlyph() {
  return (
    <svg viewBox="0 0 20 20" className="h-5 w-5" fill="none" aria-hidden>
      <path d="M8 8V12H12V8H8Z" fill="white" fillOpacity="0.9" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
function MemoryGlyph() {
  return (
    <svg viewBox="0 0 20 20" className="h-5 w-5" fill="none" aria-hidden>
      <rect x="1.5" y="5.5" width="17" height="9" rx="2" fill="white" fillOpacity="0.9" />
      <rect x="3.5" y="7.2" width="2.3" height="1.8" rx="0.2" fill="#1f2937" />
      <rect x="6.3" y="7.2" width="2.3" height="1.8" rx="0.2" fill="#1f2937" />
      <rect x="9.1" y="7.2" width="2.3" height="1.8" rx="0.2" fill="#1f2937" />
      <rect x="11.9" y="7.2" width="2.3" height="1.8" rx="0.2" fill="#1f2937" />
      <rect x="14.7" y="7.2" width="1.8" height="1.8" rx="0.2" fill="#1f2937" />
      <rect x="3.5" y="2.4" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="7.1" y="2.4" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="10.7" y="2.4" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="14.3" y="2.4" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="3.5" y="15.6" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="7.1" y="15.6" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="10.7" y="15.6" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
      <rect x="14.3" y="15.6" width="1.6" height="2" rx="0.2" fill="white" fillOpacity="0.85" />
    </svg>
  );
}
