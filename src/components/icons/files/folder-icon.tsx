  ...
  return (
    ...
    >
      <g clipPath="url(#folder-clip0)">
        ...
        {isEmpty && (
          <g opacity="0.4">
            <rect x="20" y="22" width="17" height="1.5" rx="0.75" fill="white" />
            <rect x="20" y="26" width="17" height="1.5" rx="0.75" fill="white" />
            <rect x="20" y="30" width="12" height="1.5" rx="0.75" fill="white" />
          </g>
        )}
      </g>
