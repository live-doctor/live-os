...
export interface App {
  ...
  changelog?: AppChangelogEntry[]; // Parsed changelog entries
  stable?: boolean; // Whether app is marked stable
  deprecated?: boolean; // Whether app is deprecated
  stars?: number; // Repository stars
  monthlyPulls?: number; // Monthly pulls from catalog
  ...
  storeIsDefault?: boolean; // True for built-in default catalogs
